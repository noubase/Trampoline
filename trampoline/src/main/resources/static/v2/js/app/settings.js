...
function setMavenInformation() {
    if ($("#input-mavenhomelocation").val() == '') {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {
                mavenHomeLocationPath: $("#input-mavenhomelocation").val(),
...
function setExternalInstance() {
    ...
    if (!cheackEmptyValuesForm(fieldsToCheck)) {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {
                name: $("#input-external-instance-name").val(),
                port: $("#input-external-instance-port").val(),
                actuatorPrefix: $("#input-external-instance-actuator-prefix").val(),
                ip: $("#input-external-instance-ip").val()
            },
            success: function (data, textStatus, jqXHR) {
                location.reload();
            },
    ...
    if ($("#input-hidden-mavenhomelocation").val() == '' && $("#input-newmicroservice-build-tool").val() == 'maven') {
        ...
        if (!cheackEmptyValuesForm(fieldsToCheck)) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {
                    name: $("#input-newmicroservice-name").val(),
                    pomLocation: $("#input-newmicroservice-pomlocation").val(),
                    defaultPort: $("#input-newmicroservice-defaultport").val(),
                    actuatorPrefix: $("#input-newmicroservice-actuatorprefix").val(),
                    vmArguments: $("#input-newmicroservice-vmarguments").val(),
                    appArguments: $("#input-newmicroservice-apparguments").val(),
                    buildTool: $("#input-newmicroservice-build-tool").val(),
                    gitLocation: $("#input-newmicroservice-gitLocation").val()
                },
                success: function (data, textStatus, jqXHR) {
                    location.reload();
                },
...
function showMicroserviceInformation(microserviceId) {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            $("#input-update-app-arguments").val(data.appArguments);
...
function copyMsInfo(microserviceId) {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            $("#input-newmicroservice-apparguments").val(data.appArguments);
...
function updateMicroService() {
    ...
    if ($("#input-update-pomLocation").val() == '' || $("#input-update-default-port").val() == '') {
        ...
        $('.front-loading').show();
        $.ajax({
            url: "/settings/updateMicroService/" + selectedMicroserviceId,
            type: "POST",
            data: {
                defaultPort: $("#input-update-default-port").val(),
                buildTool: $("#modal-microservice-buildTool").text(),
                actuatorPrefix: $("#input-update-actuator-prefix").val(),
                vmArguments: $("#input-update-vm-arguments").val(),
                appArguments: $("#input-update-app-arguments").val(),
...
function saveGitSshCred() {
    ...
    $.ajax({
        ...
        type: "POST",
        data: {
            sshKeyLocation: $("#input-git-ssh-key-location").val(),
            sshKeyPassword: $("#input-git-ssh-key-password").val()
        },
        success: function (data, textStatus, jqXHR) {
            location.reload();
        },
    ...
    if ($("#input-hidden-mavenhomelocation").val() == '' && $("#input-newmicroservice-build-tool").val() == 'maven') {
        ...
        if (!cheackEmptyValuesForm(fieldsToCheck)) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {
                    gitRepo: $('#input-git-newmicroservice-repo').val(),
