    ...
    if ($("#input-start-microservice").val() != -1) {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $("#input-start-app-arguments").val(data.appArguments);
...
function startInstance() {
    ...
    $.ajax({
        ...
        type: "POST",
        data: {
            id: $("#input-start-microservice").val(), port: $("#input-start-port").val(),
            vmArguments: $("#input-start-arguments").val(), appArguments: $("#input-start-app-arguments").val()
        },
        success: function (data, textStatus, jqXHR) {
            location.reload();
        },
